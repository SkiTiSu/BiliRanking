...
namespace MaterialSkin
{
    public class MaterialSkinManager
    {
        ...
        private MaterialSkinManager()
        {
            ...
            ROBOTO_MEDIUM_12 = new Font("Microsoft Yahei UI", 12f, FontStyle.Bold);
            ROBOTO_MEDIUM_10 = new Font("Microsoft Yahei UI", 10f, FontStyle.Bold);
            ROBOTO_REGULAR_11 = new Font("Microsoft Yahei UI", 11f);
            ROBOTO_MEDIUM_11 = new Font("Microsoft Yahei UI", 11f, FontStyle.Bold);
            Theme = Themes.LIGHT;
